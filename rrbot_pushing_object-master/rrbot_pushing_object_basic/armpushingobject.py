...
joint3publisher = rospy.Publisher('/rrbot/joint3_position_controller/command', Float64, queue_size=10)
joint4publisher = rospy.Publisher('/rrbot/joint4_position_controller/command', Float64, queue_size=10)
...
def rrarm_positions_publisher():
    global joint1publisher, joint2publisher, joint3publisher, joint4publisher
    positioning = True
    joint1initial_position = 50.0
    joint2initial_position = 2.4
    joint3initial_position = 1
    joint4initial_position = 2

...
def move_pieces(depth):
    ...
    try:
        move = chess.polyglot.MemoryMappedReader("C:/Users/Elysia/Documents/Jupyter_projects/Chess_played_arm/Image_processing/Chess/Opening_Moves/pecg_book.bin").weighted_choice(board).move
...
while True:
    ...
    if n == 1:
        ...
        y1 = key2[1]
        print(keyop1)
        movementop(chessposition,keyop1,keyop2,x,y,x1,y1)
        chessposition
